...
-- 3. how many catogary we have

		SELECT COUNT(DISTINCT category) as total_category FROM retail_sales;
        
-- <<<< Data analysis & Buseness key problems answers >>>>>
...
SELECT ROUND(AVG(age),2) AS avegare_age  from retail_sales
...
SELECT 
 category,
 gender,
COUNT(transactions_id) AS Transaction
FROM retail_sales
